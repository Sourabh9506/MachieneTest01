...
CREATE TABLE Tbl_Employee_NIS1027(
  EmployeeId INT PRIMARY KEY IDENTITY,
  EmpName VARCHAR(20),
  Phone VARCHAR(20),
  Email VARCHAR(20)
);
ALTER TABLE Tbl_Employee_NIS1027 ADD AreaCode VARCHAR(6)
UPDATE Tbl_Employee_NIS1027
SET AreaCode='234659'
WHERE EmployeeId=5;

CREATE TABLE Tbl_Manufacturer_NIS1027(
  MfName VARCHAR(20) PRIMARY KEY,
  City VARCHAR(20),
  State VARCHAR(20)
);

CREATE TABLE Tbl_Computer_1027(
  MfName VARCHAR(20) 
	CONSTRAINT fk_comp_manu 
	FOREIGN KEY (MfName)
	REFERENCES Tbl_Manufacturer_NIS1027(MfName) ,
 ...
 EmployeeId INT 
	...
	REFERENCES Tbl_Employee_NIS1027(EmployeeId)
);
INSERT INTO Tbl_Manufacturer_NIS1027 VALUES    ('Acer', 'Hsinchu', 'Taiwan'),
                                            ('HP', 'California', 'US'),
                                            ('Dell', 'Shanghai', 'China'),
...
INSERT INTO Tbl_Employee_NIS1027 VALUES
...
INSERT INTO Tbl_Computer_1027 VALUES   
...
*/
SELECT MfName FROM Tbl_Manufacturer_NIS1027
...
average.
  */
  SELECT SerialNumber
          FROM Tbl_Computer_1027
  WHERE  Weight<(SELECT AVG(Weight) FROM Tbl_Computer_1027 )
  -----------------------------------------------------------------------------------
  /*
...
computers in use. Use a subquery.
  */
  SELECT MfName 
     FROM Tbl_Manufacturer_NIS1027
  WHERE MfName NOT IN (SELECT MfName FROM Tbl_Computer_1027)
  ---------------------------------------------------------------------------
  /*
...
AS
    ...
    FROM Tbl_Employee_NIS1027 AS emp
    INNER JOIN Tbl_Computer_1027 AS comp
    ON emp.EmployeeId = comp.EmployeeID
    INNER JOIN Tbl_Manufacturer_NIS1027 AS manf
